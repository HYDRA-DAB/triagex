    ...
    <div className="bg-slate-900/50 backdrop-blur-2xl rounded-[24px] border border-white/10 p-6 md:p-8 shadow-2xl flex flex-col gap-6 h-full transform transition-all duration-500 hover:border-indigo-500/30 relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col gap-5">
        <div>
          ...
          <p className="text-sm text-indigo-100/80 leading-relaxed font-light">{facility.desc}</p>
        </div>
        ...
        <div className="bg-indigo-500/10 border border-indigo-500/20 rounded-xl p-4 flex items-start gap-3 mt-auto">
          ...
          <div className="flex flex-col">
            <span className="text-indigo-200 font-semibold text-sm">Relevant for {facility.tags[2]}</span>
            <span className="text-indigo-200/60 text-xs mt-1">Based on your symptom tracking, this facility has the right equipment and specialists.</span>
          </div>
        </div>
      </div>

      <div className="flex flex-col gap-3 mt-2">
        <button className="w-full py-4 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-400 hover:to-purple-500 text-white font-medium shadow-lg shadow-indigo-500/25 transition-all duration-300 hover:shadow-indigo-500/40 hover:-translate-y-0.5 flex justify-center items-center gap-2">
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" /></svg>
          Navigate Now
        </button>
        <button className="w-full py-3.5 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-indigo-200 hover:text-white font-medium transition-all duration-300">
